...
function getQuote(n) {
  var quotes = [
    ...
    'Jika orang tuamu nggak merestui hubungan kita, Apa yang kamu lakukan?',
    'Apakah kamu memperlakukan lawan mainmu berbeda dengan teman teman lain? Jelaskan?',
    'Adakah kalimat dariku yang membuatmu terkesan dan bersyukur memiliki aku?',
    'Adakah tujuan bersama yang ingin kamu capai bersama pasangan? Ceritakan',
    'Pernahkah kamu berdoa kepada Tuhan untuk hubungan ini? Apakah itu?',
    'DISINI',
  ];
